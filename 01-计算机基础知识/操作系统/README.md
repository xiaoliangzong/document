...
操作系统（Operating System，缩写：OS）是一种内置的程序，用来协作计算机的各种硬件，以与用户进行交互。它为用户和应用程序提供了一个接口，使它们能够与计算机硬件进行交互和利用系统资源。
...
![windows版本历史](../images/windows版本历史.png)
...
![windows server 版本历史](../images/WindowsServer版本历史.png)
...
![CentOS 版本历史](../images/CentOS版本历史.png)
...
![Debian 版本历史](../images/Debian版本历史.png)
...
![Ubantu 版本历史](../images/Ubantu版本历史.png)
...
![openSUSE 版本历史](../images/openSUSE版本历史.png)
...
KylinOS （Kylin Operating System）银河麒麟操作系统。
