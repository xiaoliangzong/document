...
CREATE tablespace "TEST" datafile 'E:\DM8\data\DAMENG\TEST_CREATE.DBF' size 2048 autoextend on maxsize 16777215 CACHE = NORMAL;
...
![DM管理工具导入导出dmp文件](./images/DM管理工具导入导出dmp截图.png.png)
