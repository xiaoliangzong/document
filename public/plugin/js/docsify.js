;(function () {
  ...
  var HashHistory = /*@__PURE__*/ (function (History) {
    ...
    HashHistory.prototype.toURL = function toURL(path, params, currentRoute) {
      return (
        '#' + History.prototype.toURL.call(this, path, params, currentRoute)
      )
    }
      ...
      parts.push(
        (custom && custom[key]) ||
          function (d) {
            return (
              '00' +
              (typeof MAP[key] === 'string' ? d[MAP[key]]() : MAP[key](d))
            ).slice(-key.length)
          }
      )
    })
  ...
  var inline = {
    ...
    strong: {
      ...
      endAst:
        /[^punctuation\s]\*\*(?!\*)|[punctuation]\*\*(?!\*)(?:(?=[punctuation_\s]|$))/, // last char can't be punct, or final * must also be followed by punct (or endline)
  ...
  inline._comment = edit$1(block._comment)
    .replace('(?:-->|$)', '-->')
    .getRegex()
  ...
  var Lexer = /*@__PURE__*/ (function () {
     ...
     * Lexing/Compiling
     */
    Lexer.prototype.inlineTokens = function inlineTokens(
      src,
      tokens,
      inLink,
      inRawBlock
  ...
  var Slugger = /*@__PURE__*/ (function () {
     ...
     */
    Slugger.prototype.getNextSafeSlug = function getNextSafeSlug(
      originalSlug,
      isDryRun
    ) {
    ...
    for (var i$3 = 0, list$3 = tokens; i$3 < list$3.length; i$3 += 1) {
      ...
      switch (token.type) {
        case 'table': {
          ...
          for (
            var i$2 = 0, list$2 = token.tokens.cells;
            i$2 < list$2.length;
            i$2 += 1
          ) {
            var row = list$2[i$2]
  ...
  function replace(m, $1) {
    return (
      '<img class="emoji" src="https://github.githubassets.com/public/images/icons/emoji/' +
      $1 +
      '.png" alt="' +
      $1 +
      '" />'
  ...
  ********************************************** */
  ...
  function Render(Base) {
    return /*@__PURE__*/ (function (Base) {
      ...
      Render.prototype._bindEventOnRendered = function _bindEventOnRendered(
        activeEl
      ) {
        var ref = this.config
  ...
  function Fetch(Base) {
    ...
    return /*@__PURE__*/ (function (Base) {
      ...
      Fetch.prototype._loadSideAndNav = function _loadSideAndNav(
        path,
        qs,
        loadSidebar,
        cb
      ...
      Fetch.prototype._fetchFallbackPage = function _fetchFallbackPage(
        path,
        qs,
        cb
      ) {
  ...
  var Docsify = /*@__PURE__*/ (function (superclass) {
    ...
    Docsify.prototype.initPlugin = function initPlugin() {
      ...
      ;[].concat(this.config.plugins).forEach(function (fn) {
        return isFn(fn) && fn(this$1._lifecycle, this$1)
      })
    }
